...
function prepareTaskModal() {
    const modal = bootstrap__WEBPACK_IMPORTED_MODULE_5__.Modal.getOrCreateInstance(document.getElementById(`multipurposeModal`))
