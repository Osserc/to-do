...
let allTasks = _buildProject__WEBPACK_IMPORTED_MODULE_0__.currentProject.tasks
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "currentProject": () => (/* reexport safe */ _buildProject__WEBPACK_IMPORTED_MODULE_0__.currentProject),
...
function prepareTaskModal(type, action) {
    ...
    const form = (0,_domForms__WEBPACK_IMPORTED_MODULE_3__.buildForm)(type, action, _buildProject__WEBPACK_IMPORTED_MODULE_0__.currentProject.tasks.length)
...
function successfulProjectCreation(event) {
    (0,_buildProject__WEBPACK_IMPORTED_MODULE_0__.addProject)(event.target.elements)
    bootstrap__WEBPACK_IMPORTED_MODULE_5__.Modal.getInstance(document.getElementById(`multipurposeModal`)).hide()
    let project = _buildProject__WEBPACK_IMPORTED_MODULE_0__.allProjects[_buildProject__WEBPACK_IMPORTED_MODULE_0__.allProjects.length - 1]
    updateProjectsList()
}

function successfulTaskCreation(event) {
    (0,_buildTask__WEBPACK_IMPORTED_MODULE_4__.addTask)(event.target.elements)
    bootstrap__WEBPACK_IMPORTED_MODULE_5__.Modal.getInstance(document.getElementById(`multipurposeModal`)).hide()
