...
function decryptData(data) {
    data.forEach((project) => {
        ...
        project.tasks.forEach((task) => {
            if (task == null) return
            _buildTask__WEBPACK_IMPORTED_MODULE_6__.createTask(task.title, task.priority)
        })
    })
}
