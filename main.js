...
function buildProjectDate() {
    ...
    dueDate.innerHTML = _buildProject__WEBPACK_IMPORTED_MODULE_0__.currentProject.dueDate
    return dueDate
}
...
function buildProjectPriority() {
    ...
    priority.classList.add(`col-md-5`, `col-12`, (0,_domTaskShared__WEBPACK_IMPORTED_MODULE_2__.determinePriorityColor)(_buildProject__WEBPACK_IMPORTED_MODULE_0__.currentProject.priority), `fw-bold`, `text-center`, `text-md-start`)
