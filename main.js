...
/* harmony export */   "initializeCurrentProject": () => (/* binding */ initializeCurrentProject)
/* harmony export */ });
...
function changeCurrentProject(id = null) {
    if ((currentProject == null) && (allProjects.every((project) => project == null))) {
        ...
        ;(0,_buildTask__WEBPACK_IMPORTED_MODULE_0__.refreshAllTasks)()
    }
}
...
/* harmony export */   "refreshAllTasks": () => (/* binding */ refreshAllTasks)
/* harmony export */ });
...
function addTask(elements) {
    ...
    localStorage.setItem(`storedData`, JSON.stringify(_buildProject__WEBPACK_IMPORTED_MODULE_0__.allProjects))
    console.log(JSON.parse(localStorage.getItem(`storedData`)))
}
...
/* harmony import */ var _domProject__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./domProject */ "./src/js/domManipulation/domProject.js");
...
function activateEditForm(type, action, id = null) {
    ...
    form.addEventListener(`submit`, function() {
        ...
        if (type == `Project`) {
            ...
            ;(0,_domProject__WEBPACK_IMPORTED_MODULE_3__.buildProjectsList)()
        } else {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "buildProjectsList": () => (/* binding */ buildProjectsList),
...
function removeProject(id) {
    ...
    if ((_buildProject__WEBPACK_IMPORTED_MODULE_0__.currentProject != null) && (_buildProject__WEBPACK_IMPORTED_MODULE_0__.currentProject.id == id)) {
        (0,_buildProject__WEBPACK_IMPORTED_MODULE_0__.initializeCurrentProject)()
        showProject()
        ;(0,_buildTask__WEBPACK_IMPORTED_MODULE_4__.refreshAllTasks)()
...
function buildCheckmarkButton(id) {
    ...
    checkButton.addEventListener('change', function() {
        ...
        localStorage.setItem(`storedData`, JSON.stringify(_buildProject__WEBPACK_IMPORTED_MODULE_1__.allProjects))
    })
    checkButton.addEventListener(`change`, _domProject__WEBPACK_IMPORTED_MODULE_3__.refreshProjectProgress)
    return checkButton
}
...
function removeTask(id) {
    ...
    localStorage.setItem(`storedData`, JSON.stringify(_buildProject__WEBPACK_IMPORTED_MODULE_1__.allProjects))
    singleTask.remove()
    ;(0,_domProject__WEBPACK_IMPORTED_MODULE_3__.refreshProjectProgress)()
}
